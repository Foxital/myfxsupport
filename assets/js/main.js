...
if ($('.menu-area li.menu-item-has-children-lang ul').length) {
	$('.menu-area .navigation li.menu-item-has-children-lang').append('<div class="dropdown-btn"><span class="fas fa-angle-down"></span></div>');
}
...
if ($('.mobile-menu').length) {
	...
	$('.mobile-menu li.menu-item-has-children-lang .dropdown-btn').on('click', function () {
		$(this).toggleClass('open');
		$(this).prev('ul').slideToggle(500);
	});
